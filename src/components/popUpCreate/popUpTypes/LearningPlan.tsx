...
const LearningPlan = forwardRef<LearningPlanHandles, LearningPlanProps>(
  (
    {
      initialData,
      moduleOptions,
    ...
    const [errors, setErrors] = useState<
      Partial<Record<keyof LearningPlanData, string>>
    >({});
    ...
    const getErrors = useCallback((data: LearningPlanData) => {
      ...
      if (moduleError) newErrors.module = moduleError;
    ...
    const handleChange = (
      ...
      if (hasAttemptedSubmit) {
        ...
        if (
          newErrors[name as keyof LearningPlanData] !==
          errors[name as keyof LearningPlanData]
        ) {
          setErrors((prevErrors) => ({
            ...prevErrors,
            [name as keyof LearningPlanData]:
              newErrors[name as keyof LearningPlanData],
          }));
        }
      }
